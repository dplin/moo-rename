...
if (typeof current === 'undefined') {
   console.error('No pattern given! Please try again.');
   process.exit(1);
}

var FileSet = fileSet([current]);

if (FileSet.files.length > 0){
    console.error('\n#################### New filenames(%s) ##################', FileSet.files.length);
...
if (FileSet.dirs.length > 0){
    FileSet.dirs.forEach(function(dir) {
        var nfs = fileSet([dir+"\*"]);
        console.error('\n#################### New filenames(%s) ##################', nfs.files.length);
